...
6. Panoptic SegFormer: Delving Deeper into Panoptic Segmentation with Transformers

7. MultiPath: Multiple Probabilistic Anchor Trajectory Hypotheses for Behavior Prediction

8. Language Agent for Autonomous Driving

9. TrackFormer: Multi-Object Tracking with Transformers

10. YOLACT: Real-time Instance Segmentation

11. A Multiple Shooting Algorithm for Direct Solution of Optimal Control Problems
